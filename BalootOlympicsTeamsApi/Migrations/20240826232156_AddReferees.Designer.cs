...
namespace BalootOlympicsTeamsApi.Migrations
{
    ...
    [Migration("20240826232156_AddReferees")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BalootOlympicsTeamsApi.Entities.Group", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<DateTimeOffset>("StartPlayAt")
                        .HasColumnType("timestamp with time zone")
            ...
            modelBuilder.Entity("BalootOlympicsTeamsApi.Entities.Match", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int?>("MatchQualifyThemTeamId")
                        .HasColumnType("integer");

                    b.Property<int?>("MatchQualifyUsTeamId")
                        .HasColumnType("integer");

                    b.Property<Guid?>("QydhaGameId")
                        .HasColumnType("uuid")
                    ...
                    b.Property<int?>("ThemTeamId")
                        .HasColumnType("integer");

                    b.Property<int?>("UsTeamId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("MatchQualifyThemTeamId")
                        .IsUnique();

                    b.HasIndex("MatchQualifyUsTeamId")
                        .IsUnique();

                    b.HasIndex("RefereeId");

                    b.HasIndex("ThemTeamId");
            ...
            modelBuilder.Entity("BalootOlympicsTeamsApi.Entities.Referee", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("referees_pkey");

                    b.HasIndex(new[] { "Phone" }, "player_phone_key")
                        .IsUnique()
                        .HasDatabaseName("player_phone_key1");
            ...
            modelBuilder.Entity("BalootOlympicsTeamsApi.Entities.Match", b =>
                {
                    b.HasOne("BalootOlympicsTeamsApi.Entities.Group", "Group")
                        .WithMany("Matches")
                        .HasForeignKey("GroupId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("BalootOlympicsTeamsApi.Entities.Match", "MatchQualifyThemTeam")
                        .WithOne()
                        .HasForeignKey("BalootOlympicsTeamsApi.Entities.Match", "MatchQualifyThemTeamId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("BalootOlympicsTeamsApi.Entities.Match", "MatchQualifyUsTeam")
                        .WithOne()
                        .HasForeignKey("BalootOlympicsTeamsApi.Entities.Match", "MatchQualifyUsTeamId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("BalootOlympicsTeamsApi.Entities.Referee", "Referee")
                        .WithMany()
                        .HasForeignKey("RefereeId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("BalootOlympicsTeamsApi.Entities.Team", "ThemTeam")
                        .WithMany()
                        .HasForeignKey("ThemTeamId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("BalootOlympicsTeamsApi.Entities.Team", "UsTeam")
                        .WithMany()
                        .HasForeignKey("UsTeamId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.Navigation("Group");

                    b.Navigation("MatchQualifyThemTeam");

                    b.Navigation("MatchQualifyUsTeam");

                    b.Navigation("Referee");

                    b.Navigation("ThemTeam");
